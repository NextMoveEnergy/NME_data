...
sifra_zaracunljivega_elementa = {
    ...
    '2006': 'Dogovorjena moč za časovni blok 1 z olajšavo',
    '2007': 'Dogovorjena moč za časovni blok 2 z olajšavo',
    '2008': 'Dogovorjena moč za časovni blok 3 z olajšavo',
    '2009': 'Dogovorjena moč za časovni blok 4 z olajšavo',
    '2010': 'Dogovorjena moč za časovni blok 5 z olajšavo',
    ...
    '2206': 'Prevzeta EE za časovni blok 1 z olajšavo',
    '2207': 'Prevzeta EE za časovni blok 2 z olajšavo',
    '2208': 'Prevzeta EE za časovni blok 3 z olajšavo',
    '2209': 'Prevzeta EE za časovni blok 4 z olajšavo',
    '2210': 'Prevzeta EE za časovni blok 5 z olajšavo',
...
def extract_splosno_priloge(priloga):
    obvestilo_elem = priloga.find('ObvestiloDogovorjenaMoc/Obvestilo/Vsebina')
    vsebina_text = obvestilo_elem.text.strip() if obvestilo_elem is not None and obvestilo_elem.text else ''
...
def convert_to_df(data):
    columns=[
        ...
        "2000_SifraZaracunljivegaElementa",
        "2000_ObdobjeOd",
        "2000_ObdobjeDo",
        "2000_Kolicina",
        "2000_EnotaMere",
        "2000_Cena",
        "2000_DatumUveljavitveCene",
        "2000_Valuta",
        "2000_Znesek",
        "2000_StopnjaDDV",
